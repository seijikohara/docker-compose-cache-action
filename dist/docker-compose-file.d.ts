 ...
 */
export declare function getComposeServicesFromFiles(composeFilePaths: ReadonlyArray<string>, excludedImageNames: ReadonlyArray<string>): ReadonlyArray<ComposeService>;
