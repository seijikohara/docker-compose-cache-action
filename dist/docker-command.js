 ...
 */
export async function pullImage(imageName, platform) {
    try {
 ...
 */
export async function inspectImageRemote(imageName) {
    try {
        const execOptions = {
 ...
 */
export async function inspectImageLocal(imageName) {
    try {
        const execOptions = {
            ignoreReturnCode: true,
        };
 ...
 * @returns Promise resolving to boolean indicating success or failure.
 */
export async function saveImageToTar(imageName, outputPath) {
    try {
        const execOptions = { ignoreReturnCode: true };
 ...
 * @returns Promise resolving to boolean indicating success or failure.
 */
export async function loadImageFromTar(tarPath) {
    try {
        const execOptions = { ignoreReturnCode: true };
