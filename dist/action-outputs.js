 ...
 */
export function setActionOutputs(allServicesFromCache, processedImageList) {
 ...
 */
export function buildProcessedImageList(serviceResults) {
 ...
 */
export function calculateActionSummary(serviceResults, executionTimeMs) {
 ...
 */
export function createActionSummary(serviceResults, summary, referencedComposeFiles, skipLatestCheck) {
 ...
 */
export function logActionCompletion(summary) {
    const actionHumanReadableDuration = formatTimeBetween(0, summary.executionTimeMs);
